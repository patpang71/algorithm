...
public class TrieTree {
	...
	/*
	 * Call the TrieNode class for insert
	 */
	...
	/*
	 * Use this to search for the underlying Trie tree structure 
	 * after the prefix ends, loop and see if there is a non-empty 
	 * node, recursively search for the branch below.
	 * When see hasWord=true, save the result
	 */
